...
async def run_discord(settings: Settings) -> int:
    ...
    context_builder = ContextBuilder(
        ...
        recent_channel_window=timedelta(minutes=settings.ai_recent_channel_context_minutes),
        recent_messages_per_channel=settings.ai_recent_messages_per_channel,
        maximum_recent_channel_characters=(settings.ai_recent_channel_context_characters),
